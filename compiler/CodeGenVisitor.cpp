...
antlrcpp::Any CodeGenVisitor::visitVar_assign_stmt(ifccParser::Var_assign_stmtContext *ctx)
{
...
antlrcpp::Any CodeGenVisitor::visitVar_decl_assign_stmt(ifccParser::Var_decl_assign_stmtContext *ctx)
{
    Type type = typeMap[ctx->TYPE()->getText()];
...
bool CodeGenVisitor::addSymbol(antlr4::ParserRuleContext *ctx, const std::string &id, const Type &type)
{

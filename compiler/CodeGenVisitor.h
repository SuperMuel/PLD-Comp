...
public:
    ...
    virtual antlrcpp::Any visitVar_decl_assign_stmt(ifccParser::Var_decl_assign_stmtContext *ctx) override;
...
private:
    ...
    bool addSymbol(antlr4::ParserRuleContext *ctx, const std::string &id, const Type &type);
